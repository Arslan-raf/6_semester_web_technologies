class HeaderApp extends React.Component{
    ...
    render(){
        ...
        if (error) {
            ...
            return(
                <header className="header container-fluid sticky-top bg-primary text-white">
                   <HeaderDesc/>
            ...
            return(
                <div className="container-sm">
                    <div className="row align-items-center">
                        <HeaderData headerData={"Арслан Рафиков ПИ-319"}/>
                        <HeaderData headerData={"Лабораторная работа №5"}/>
                        <HeaderData headerData={"Охота на утку"}/>
                    </div>
                </div>
            );
        }
